...
def cir_RsRQRQQ(
    ...
    """
    Simulation Function: -Rs-RQ-RQ-Q-
    Return the impedance of an Rs-RQ-RQ-Q circuit. See details for RQ under cir_RQ_fit()
    ...
    n3 = Constant phase elelment exponent [-]
    """
    if R == "none":
        R = 1 / (Q * (2 * np.pi * fs) ** n)
    elif Q == "none":
    ...
    return (
        Rs + (R / (1 + R * Q * (w * 1j) ** n)) + (R2 / (1 + R2 * Q2 * (w * 1j) ** n2)) + 1 / (Q3 * (w * 1j) ** n3)
    )
...
def cir_RsRQRQRQ(
    ...
    Return the impedance of an Rs-RQ-RQ-RQ circuit.
    Function added by PY
    Inputs
    ----------
    w = Angular frequency [1/s]
    Rs = Series Resistance [Ohm]
...
def cir_RsRQRQQ_fit(params, w):
    ...
    Return the impedance of an Rs-RQ-RQ-Q circuit. See details under cir_RsRQRQQ()
...
def cir_RsRQRQRQ_fit(params, w):
    ...
    Rs = params["Rs"]
    return (
        Rs + (R / (1 + R * Q * (w * 1j) ** n)) + (R2 / (1 + R2 * Q2 * (w * 1j) ** n2)) + (R3 / (1 + R3 * Q3 * (w * 1j) ** n3))
    )
    ...
    def EIS_fit(self, params, circuit, weight_func="modulus", nan_policy="raise"):
        ...
        if circuit == "C":
                ...
                if "'fs'" in str(self.Fit[i].params.keys()) and "'fs2'" in str(
                    ...
                    self.circuit_fit.append(
                        cir_RsRQRQQ(
                            ...
                            n2=self.Fit[i].params.get("n2").value,
                            fs2=self.Fit[i].params.get("fs2").value,
                            Q3=self.Fit[i].params.get("Q3").value,
            ...
            for i in range(len(self.df)):
                if "'fs'" in str(self.Fit[i].params.keys()) and "'fs2'" in str(
                    ...
                    self.circuit_fit.append(
                        cir_RsRQRQ(
                            ...
                            n2=self.Fit[i].params.get("n2").value,
                            fs2=self.Fit[i].params.get("fs2").value,
                            R3=self.Fit[i].params.get("R3").value,
                            Q3="none",
                            n3=self.Fit[i].params.get("n3").value,
                ...
                elif "'Q'" in str(self.Fit[i].params.keys()) and "'fs2'" in str(self.Fit[i].params.keys()) and "'fs3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
                    ...
                    self.fit_n3.append(self.Fit[i].params.get("n3").value)
                    self.fit_fs3.append(self.Fit[i].params.get("fs3").value)
                elif "'fs'" in str(self.Fit[i].params.keys()) and "'Q2'" in str(self.Fit[i].params.keys()) and "'fs3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
                    ...
                    self.fit_n3.append(self.Fit[i].params.get("n3").value)
                    self.fit_fs3.append(self.Fit[i].params.get("fs3").value)
                elif "'Q'" in str(self.Fit[i].params.keys()) and "'Q2'" in str(self.Fit[i].params.keys()) and "'fs3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
                    ...
                    self.fit_n3.append(self.Fit[i].params.get("n3").value)
                    self.fit_fs3.append(self.Fit[i].params.get("fs3").value)
                elif "'fs'" in str(self.Fit[i].params.keys()) and "'fs2'" in str(self.Fit[i].params.keys()) and "'Q3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
                    ...
                    self.fit_n3.append(self.Fit[i].params.get("n3").value)
                    self.fit_Q3.append(self.Fit[i].params.get("Q3").value)
                elif "'Q'" in str(self.Fit[i].params.keys()) and "'fs2'" in str(self.Fit[i].params.keys()) and "'Q3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
                    ...
                    self.fit_n3.append(self.Fit[i].params.get("n3").value)
                    self.fit_Q3.append(self.Fit[i].params.get("Q3").value)
                elif "'fs'" in str(self.Fit[i].params.keys()) and "'Q2'" in str(self.Fit[i].params.keys()) and "'Q3'" in str(self.Fit[i].params.keys()):
                    self.circuit_fit.append(
                        cir_RsRQRQRQ(
                            w=self.df[i].w,
                            Rs=self.Fit[i].params.get("Rs").value,
